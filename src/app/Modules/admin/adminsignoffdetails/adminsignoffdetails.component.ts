...
import { AdminService, ibeddetails, icountertopdetails, icpfittingdetails, ikitcehnhardwaredetails, ikitchenbasketdetails, ikitchendrawersdetails, ikitchenhingesdetails, isinkdetails, itilesdetails, itvunitdetails, iwardrobebasketdetails, iwardrobedetails, iwardrobedrawersdetails, iwardrobehardwaredetails, iwardrobehingesdetails, kitchendetails } from '../admin.service';


@Component({
  selector: 'app-adminsignoffdetails',
  templateUrl: './adminsignoffdetails.component.html',
  styleUrls: ['./adminsignoffdetails.component.css']
})
export class AdminsignoffdetailsComponent implements OnInit {
  ...
  constructor(private http:AdminService,private route:Router,private routeee:ActivatedRoute) { }
